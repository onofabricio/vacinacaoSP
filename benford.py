...
#DataBase
end_vacinometro = 'https://github.com/onofabricio/vacinacaoSP/blob/main/vacinometroSP.csv.zip?raw=true'
df_vacinometro = pd.read_csv(end_vacinometro, index_col=0, compression = 'zip')
